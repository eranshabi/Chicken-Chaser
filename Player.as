package  {
	...
	import flash.display.Stage;
		...
		public var melee:Attack; //Current Attack pointer
			...
			public var _punch1combo:Attack = new Attack("punch1c", 1, true, 0, 0, false, 77, 22, false, false, 0.03);
			
			public var _punch2:Attack = new Attack("punch2", 1, true, 0, 0, false, 77, 20, true, false,0.03);
			public var _punch2combo:Attack = new Attack("punch2c", 1, false, 3, -20, false, 77, 22, true, false, 0.03);
			
			public var _spin:Attack = new Attack("spin", 1.5, false, 15, -20, false, 77, 40, true, false, 0.03);
			
			public var _punch1H:Attack = new Attack("punchH1", 1.5, false, 0, -25, false, 77, 25, false, false, 0.03);
			public var _punch2H:Attack = new Attack("punchH3", 1.5, false, 20, -20, true, 77, 25, true, false, 0.03);
			public var _punchSpinH:Attack = new Attack("punch2", 2, true, 0, 0, false, 77, 15, true, false, 0.03);
			public var _punch3H:Attack = new Attack("punchH2", 1.5, false, 25, -40, true, 77, 30, false, false, 0.03);
